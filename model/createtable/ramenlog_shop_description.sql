...
--
-- Table structure for table `shop_description`
--
...
--
-- Dumping data for table `shop_description`
--

LOCK TABLES `shop_description` WRITE;
/*!40000 ALTER TABLE `shop_description` DISABLE KEYS */;
/*!40000 ALTER TABLE `shop_description` ENABLE KEYS */;
UNLOCK TABLES;
