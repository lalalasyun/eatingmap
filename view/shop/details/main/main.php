    ...
    <div class="mt-5">
        ...
        <?php if ($_SESSION['auth']) { ?>
            <?php if (check_user_review($dbh, $_SESSION['account'], $SHOP_DATA["id"])) { ?>
                <div>
                    <div>
                        <button class="btn btn-info btn-lg" onclick="location.href='/view/shop/edit_review/'">
                            レビュー編集
                        </button>
                    </div>
                </div>
            <?php } else { ?>
                <div>
                    <div>
                        <button class="btn btn-info btn-lg" onclick="location.href='/view/shop/register_review/'">
                            レビュー登録
                        </button>
                    </div>
                </div>
