    ...
    <div class="w-100 m-3">
        ...
        <div>
            <div class="d-flex justify-content-around py-3">
                <button type="button" class="btn btn-primary" style="width:25%;height:20%" onclick="location.href='/view/account/favorite/index.php'">お気に入り</button>
                <button type="button" class="btn btn-primary" style="width:25%;height:20%" onclick="location.href='/view/account/review/index.php'">レビュー履歴</button>

            </div>

            <div class="d-flex justify-content-around py-3">
                <button type="button" class="btn btn-primary" style="width:25%;height:20%" onclick="location.href='/view/avatar/buy/index.php'">アバター購入</button>
                <button type="button" class="btn btn-primary " style="width:25%;height:20%" onclick="location.href='/view/profile/edit/'">プロフィール編集</button>
