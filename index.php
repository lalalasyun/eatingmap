...
//各変数の初期化
require 'web/model/db_helper.php';
require_once dirname(__FILE__) . "/web/libs/php/Mobile_Detect.php";
...
if($sp_url[1] === "shop"){
    ...
    include "web/view/shop/details/index.php";
    die();
}
...
if($sp_url[1] === "user"){
    ...
    include "web/view/profile/description/index.php";
    die();
}
